...
type RateLimiterClient interface {
	AllowRequest(ctx context.Context, in *AllowRequestParam, opts ...grpc.CallOption) (*AllowRequestResponse, error)
}
...
func (c *rateLimiterClient) AllowRequest(ctx context.Context, in *AllowRequestParam, opts ...grpc.CallOption) (*AllowRequestResponse, error) {
	out := new(AllowRequestResponse)
	err := c.cc.Invoke(ctx, "/rate.RateLimiter/allowRequest", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RateLimiterServer interface {
	AllowRequest(context.Context, *AllowRequestParam) (*AllowRequestResponse, error)
...
func (UnimplementedRateLimiterServer) AllowRequest(context.Context, *AllowRequestParam) (*AllowRequestResponse, error) {
...
func _RateLimiter_AllowRequest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rate.RateLimiter/allowRequest",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RateLimiterServer).AllowRequest(ctx, req.(*AllowRequestParam))
	}
